...
subroutine rk4ob
    ...
    do ip = 1, np
        ...
        br = spline2d(r0(ip), z0(ip), nw, nh, rsp, zsp, Brsp)
        bt = spline2d(r0(ip), z0(ip), nw, nh, rsp, zsp, Btsp)
        bz = spline2d(r0(ip), z0(ip), nw, nh, rsp, zsp, Bzsp)
        ...
        z1(ip) = z0(ip) + vz1(ip) * dt / 2(ip)
        r1(ip) = sqrt(x1(ip)^2 + y1(ip)^2)

        br = spline2d(r1(ip), z1(ip), nw, nh, rsp, zsp, Brsp)
        bt = spline2d(r1(ip), z1(ip), nw, nh, rsp, zsp, Btsp)
        bz = spline2d(r1(ip), z1(ip), nw, nh, rsp, zsp, Bzsp)
        ...
        br = spline2d(r2(ip), z2(ip), nw, nh, rsp, zsp, Brsp)
        bt = spline2d(r2(ip), z2(ip), nw, nh, rsp, zsp, Btsp)
        bz = spline2d(r2(ip), z2(ip), nw, nh, rsp, zsp, Bzsp)
        ...
        br = spline2d(r3(ip), z3(ip), nw, nh, rsp, zsp, Brsp)
        bt = spline2d(r3(ip), z3(ip), nw, nh, rsp, zsp, Btsp)
        bz = spline2d(r3(ip), z3(ip), nw, nh, rsp, zsp, Bzsp)
